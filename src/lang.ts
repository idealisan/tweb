const lang = {
  ...
  'ChatExport.Menu': 'Export Chat History',
  'ChatExport.Settings.Title': 'Chat Expert Settings',
  'ChatExport.Settings.Media': 'Media',
  'ChatExport.Settings.SelectAll': 'Select all',
  'ChatExport.Settings.Photos': 'Photos',
  'ChatExport.Settings.Videos': 'Videos',
  'ChatExport.Settings.Voice': 'Voice',
  'ChatExport.Settings.VideoNotes': 'Video Notes',
  'ChatExport.Settings.Stickers': 'Stickers',
  'ChatExport.Settings.AnimatedGif': 'Animated GIF',
  'ChatExport.Settings.Files': 'Files',
  'ChatExport.Settings.MaxMediaSize': 'Maximum media file size:',
  'ChatExport.Settings.Format': 'Format',
  'ChatExport.Settings.HTML': 'HTML',
  'ChatExport.Settings.JSON': 'JSON',
  'ChatExport.Settings.ChooseFolder': 'Choose folder',
  'ChatExport.Settings.Folder': 'Folder',
  'ChatExport.Settings.SelectedFolder': 'Selected folder',
  'ChatExport.DirectoryError': 'The export folder could not be opened.',
  'ChatExport.Settings.From': 'From',
  'ChatExport.Settings.To': 'To',
  'ChatExport.Settings.AllDates': 'All dates',
  'ChatExport.Settings.Export': 'Export',
  'ChatExport.Unsupported': 'This browser cannot write directly to a folder.',
  'ChatExport.SelectFolder': 'Choose an export folder first.',
  'ChatExport.SelectFormat': 'Select at least one export format.',
  'ChatExport.InvalidDateRange': 'The start date must not be later than the end date.',
  'ChatExport.CancelTitle': 'Cancel chat export?',
  'ChatExport.CancelText': 'The current export will stop. Files already written will remain available and can be resumed later.',
  'ChatExport.Cancel': 'Stop export',
  'ChatExport.Progress': 'Exporting %1$s · %2$s / %3$s',
  'ChatExport.ShowDetails': 'Show export details',
  'ChatExport.Details': 'Export details',
  'ChatExport.NoActiveFiles': 'No files are currently downloading.',
  'ChatExport.FileProgress': '%1$s / %2$s',
  'ChatExport.Hide': 'Hide',
  'ChatExport.CancelExport': 'Cancel export',
  'ChatExport.Failed': 'Chat export failed',
  'ChatExport.Cancelled': 'Chat export cancelled',
  'ChatExport.Completed': 'Chat export completed',
  ...
  'MessageLinkSavedToSavedMessages': 'Message link saved to **Saved Messages**.',
